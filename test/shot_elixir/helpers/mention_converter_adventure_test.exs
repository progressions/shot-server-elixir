defmodule ShotElixir.Helpers.MentionConverterAdventureTest do
  ...
  describe "html_to_notion_rich_text with adventure description" do
    ...
    test "handles adjacent mentions without space" do
      ...
      html = ~s(<p>Here's <span class="mention" data-type="mention" data-id="abc" data-label="Name1" data-mention-class-name="Character" data-mention-suggestion-char="@">@Name1</span><span class="mention" data-type="mention" data-id="def" data-label="Name2" data-mention-class-name="Character" data-mention-suggestion-char="@">@Name2</span></p>)
    ...
    test "handles malformed mention spans" do
      ...
      html = ~s(<p>Here's <span data-type="mention" data-id="abc" data-label="Name">@Name</span></p>)
    ...
    test "handles Unicode characters in description" do
      ...
      html = ~s(<p>日本語 <span class="mention" data-type="mention" data-id="abc" data-label="小山田太郎" data-mention-class-name="Character" data-mention-suggestion-char="@">@小山田太郎</span></p>)
